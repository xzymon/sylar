...
public class RawDataNipponCandle {
	...
	public RawDataNipponCandle() {

	}

	public RawDataNipponCandle(int datetimeMarker, int open, int high, int low, int close) {

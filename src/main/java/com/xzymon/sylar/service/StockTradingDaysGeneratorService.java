...
@ConditionalOnProperty(name = "tradingDays.generator", havingValue = "stock")
@Service
public class StockTradingDaysGeneratorService implements TradingDaysGeneratorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(StockTradingDaysGeneratorService.class);

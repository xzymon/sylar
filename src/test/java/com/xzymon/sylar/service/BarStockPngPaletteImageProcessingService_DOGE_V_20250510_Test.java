...
public class BarStockPngPaletteImageProcessingService_DOGE_V_20250510_Test {
	...
	@BeforeAll
	void setUp() {
		ClassPathResource resource = new ClassPathResource("test-files/DOGE.V_br_20250510.png");
		File imageFile = null;
		try {
	...
	void shouldDetectDayOpenLine() {
		...
		assertEquals("0.204608", splitted[2]);
	}
}
